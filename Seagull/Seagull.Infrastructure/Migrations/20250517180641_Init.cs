        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Island_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Island_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserIsland", x => new { x.UserId, x.IslandId });
                    table.ForeignKey(
                        name: "FK_UserIsland_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserIsland_Island_IslandId",
                        column: x => x.IslandId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Island_AuthorId",
                table: "Island",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Island_OwnerId",
                table: "Island",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserIsland_IslandId",
                table: "UserIsland",
                column: "IslandId");
